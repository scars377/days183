	...
	*/
	var App = React.createClass({displayName: "App",
		...
		*/
		...
		removeAllRecord: function(e) {
			if (e.ctrlKey || confirm('是否清空紀錄') == true) {
				location.hash='';
				this.setRecords([]);
			}
		},
		...
		setRecords: function(rr) {
			...
			this.setState({records: rr, hash: hash})
		},
				...
				React.createElement("div", {className: "app"}, 
					...
					React.createElement("div", {className: "title-info"}, 
						React.createElement("ol", null, 
							React.createElement("li", null, "社會救助法第4條第5項規定略以，(中)低收入戶申請人最近一年居住國內應超過183日。"), 
							React.createElement("li", null, "「出境日」視為居住國內，「入境日」視為未居住國內。"), 
							React.createElement("li", null, "本程式僅提供簡易試算功能，實際結果仍須經主關機關核算認定。")
						)
					), 
					...
					React.createElement(Records, {records: this.state.records, removeRecord: this.removeRecord, toggleRecord: this.toggleRecord}), 

					React.createElement("br", null), 

					React.createElement("button", {className: "remove-all", onClick: this.removeAllRecord}, 
						"清空紀錄"
					), 

					this.state.hash == ''?null:
						React.createElement("div", {className: "record-url"}, 
							React.createElement("span", {className: "caption"}, "記錄網址"), ': ', 
							React.createElement("a", {href: hashURL}, hashURL)
						), 
					...
					React.createElement("div", {className: "tips"}, 
						...
						React.createElement("p", null, 
							...
							"Ctrl-點擊記錄的移除標記可略過確認框", React.createElement("br", null), 
							"Ctrl-點擊「清空記錄」按鈕可略過確認框"
						), 
						React.createElement("br", null), 
					...
					React.createElement("br", null), 
					React.createElement("a", {href: "https://github.com/scars377/days183", style: {
						fontSize: '12px'
					}, target: "_blank"}, 
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Inputs = React.createClass({displayName: "Inputs",
		getInitialState: function() {
			return {dep: false, input: '', enabled: false};
		},
		...
		inputChange: function(e) {
			...
			this.setState({input: s, enabled: enabled})
		},
		...
		render: function() {
			return (
				React.createElement("div", null, 
					...
					React.createElement("textarea", {className: "paste-input", ref: "import", onChange: this.importFromText}), 
					...
					React.createElement("div", {className: "inputs"}, 
						...
						React.createElement("button", {className: 'dep ' + (this.state.dep
							? 'active'
							: 'deactive'), onClick: this.setDep(true)}, 
							"出境"
						), 

						React.createElement("button", {className: 'arr ' + (!this.state.dep
							? 'active'
							: 'deactive'), onClick: this.setDep(false)}, 
							"入境"
						), 

						React.createElement("input", {type: "text", ref: "input", placeholder: "輸入日期", value: this.state.input, onKeyDown: this.inputDown, onChange: this.inputChange}), 

						React.createElement("button", {className: this.state.enabled
							? 'enabled'
							: 'disabled', onClick: this.addRecord}, 
							"加入"
						)
					), 
					React.createElement("hr", null)
