		...
		return (
			<div className='app'>
				...
				<div className='title-info'>
					<ol>
						<li>社會救助法第4條第5項規定略以，(中)低收入戶申請人最近一年居住國內應超過183日。</li>
						<li>「出境日」視為居住國內，「入境日」視為未居住國內。</li>
						<li>本程式僅提供簡易試算功能，實際結果仍須經主關機關核算認定。</li>
					</ol>
				</div>
				...
				<Records records={this.state.records} removeRecord={this.removeRecord} toggleRecord={this.toggleRecord}/>

				<br/>

				<button className='remove-all' onClick={this.removeAllRecord}>
					清空紀錄
				</button>

				{this.state.hash == ''?null:
					<div className='record-url'>
						<span className='caption'>記錄網址</span>{': '}
				...
				<br/>
				<a href="https://github.com/scars377/days183" style={{
					fontSize: '12px'
				}} target="_blank">
